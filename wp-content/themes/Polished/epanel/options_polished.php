	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Blue", "Green", "Purple", "Red", "Turquoise", "Yellow" )),
...
function custom_colors_css(){
	...
	<style type="text/css">
		#content #main .new_post { color: #<?php echo(get_option($shortname.'_color_mainfont')); ?>; }
		a { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		.sf-menu a { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		.sf-menu li a:hover { color: #<?php echo(get_option($shortname.'_color_pagelink_active')); ?>; }
		div.new_post h2.title a, h1, h2, h3, h4, h5, h6, h1 a, h2 a, h3 a, h4 a, h5 a, h6 a { color: #<?php echo(get_option($shortname.'_color_headings')); ?>; }
		
		#sidebar a { color:#<?php echo(get_option($shortname.'_color_sidebar_links')); ?>; }		
		#footer_widgets .block_b h2 { color:#<?php echo(get_option($shortname.'_footer_headings')); ?> }
		#footer_widgets .widget-content, #footer_widgets a { color:#<?php echo(get_option($shortname.'_color_footerlinks')); ?> }
	</style>
