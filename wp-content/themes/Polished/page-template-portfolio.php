				...
				<div class="new_post entry clearfix">
					...
					<h1 id="post-title"><?php the_title(); ?></h1>
						<div class="postcontent">		
												...
												<div class="et_pt_portfolio_item">
													...
													<div class="et_pt_portfolio_entry<?php if ( $height == $et_portrait_height ) echo ' et_portrait_layout'; ?>">
														<div class="et_pt_portfolio_image<?php if ($et_videolink <> '') echo ' et_video'; ?>">
															...
															<a class="et_portfolio_zoom_icon <?php if ($et_videolink <> '') echo 'et_video_lightbox'; else echo('fancybox'); ?>" title="<?php the_title(); ?>"<?php if ($et_videolink == '') echo ' rel="portfolio"'; ?> href="<?php if ($et_videolink <> '') echo $et_videolink; else echo($thumbnail['fullpath']); ?>"><?php esc_html_e('Zoom','Polished'); ?></a>
															<a class="et_portfolio_more_icon" href="<?php the_permalink(); ?>"><?php esc_html_e('Read more','Polished'); ?></a>
							...
							<?php edit_post_link(esc_html__('Editar página','Polished')); ?>
							<div class="clear"></div>
