...
<?php endif; ?>
<?php if ('open' == $post->comment_status) : ?>
	<?php comment_form( array('label_submit' => esc_attr__( 'Enviar comentário', 'Polished' ), 'title_reply' => '<span>' . esc_attr__( 'Leave a Reply', 'Polished' ) . '</span>', 'title_reply_to' => esc_attr__( 'Leave a Reply to %s' )) ); ?>
<?php else: ?>
