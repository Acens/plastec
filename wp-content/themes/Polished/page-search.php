						...
						<div class="postcontent">		
							...
							<div id="et-search">
								<div id="et-search-inner" class="clearfix">
									<p id="et-search-title"><span><?php esc_html_e('procurar...','Polished'); ?></span></p>
									<form action="<?php echo home_url(); ?>" method="get" id="et_search_form">
										<div id="et-search-left">
											<p id="et-search-word"><input type="text" id="et-searchinput" name="s" value="<?php esc_attr_e('procurar...','Polished'); ?>" /></p>
										...
										<div id="et-search-right">
											...
											<input class="et_search_submit" type="submit" value="<?php esc_attr_e('Enviar','Polished'); ?>" id="et_search_submit" />
										</div> <!-- #et-search-right -->
									</form>
